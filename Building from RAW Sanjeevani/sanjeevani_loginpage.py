...
class Ui_MainWindow(object):
    def button_click_login(self):
        if self.lineEdit.text() =='miroom' and self.lineEdit_2.text() == 'miroom':
            ...
            self.show_errormessage()

    def button_click_cancel(self):
        MainWindow.hide()
    def show_errormessage(self):
        msg = QMessageBox()
...
"background-color: rgb(247, 231, 255);")
        ...
        self.pushButton_2.clicked.connect(self.button_click_cancel)
        ...
        self.label_7.setGeometry(QtCore.QRect(40, 10, 101, 81))
