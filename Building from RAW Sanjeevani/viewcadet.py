...
class Ui_MainWindow(object):
    def show_cadetdetails(self):
        ...
        self.label_6.setGeometry(QtCore.QRect(650, 50, 200, 200))
        pathname = 'images/'+str(roll_no)+'.jpg'
        self.label_6.setPixmap(QtGui.QPixmap(pathname))
    ...
    def setupUi(self, MainWindow):
        ...
        #self.tableWidget.setFont(QFont='Arial')
        self.tableWidget.setColumnHidden(0,True)
        self.tableWidget.setHorizontalHeaderLabels(("Slno","Rollno","Name","Class","Section","House"))
